...
:::note
For inbound email webhooks, the test sends a dummy email-style payload. For scheduled webhooks, the test verifies the configured target URL and returns delivery status, but it does not relax the 30-day scheduling limit.
:::
