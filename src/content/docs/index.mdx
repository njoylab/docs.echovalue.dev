...
# → {"mailboxId":"r_abcd1234","webhook":"https://yourdomain.com/webhook","email":"r_abcd1234@hook.echovalue.dev",...}
...
| **Mail2Webhook** | Receive emails at an opaque mailbox address (`<mailboxId>@hook.echovalue.dev`) and forward them to your webhook |
