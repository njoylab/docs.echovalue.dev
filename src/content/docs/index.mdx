...
See [installation details](https://github.com/njoylab/docs.echovalue.dev/blob/main/INSTALL.md) for Claude, Cursor, and Continue setup.

Claude loads the shared skill directory automatically. Cursor and Continue use local files in the workspace.
