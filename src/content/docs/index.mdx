...
Install the echoValue skill to let your AI agent execute operations on your behalf:
...
- ✅ Configure webhooks (Slack, Discord, Teams, Telegram, PagerDuty)
- ✅ Execute key-value operations (get/set/delete)
- ✅ Manage tokens (check balance, view logs)
...
The skill activates automatically when you mention echoValue or related topics.

:::note
See [installation details](https://github.com/njoylab/docs.echovalue.dev/blob/main/INSTALL.md) for manual install and advanced setup.
:::
